...
(cl:defmethod cl:initialize-instance :after ((m <send>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'send)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name simple_navigation_goals-msg:<send> is deprecated: use simple_navigation_goals-msg:send instead.")))

(cl:ensure-generic-function 'time-val :lambda-list '(m))
(cl:defmethod time-val ((m <send>))
...
(cl:defmethod RXlinear-val ((m <send>))
...
(cl:defmethod RYlinear-val ((m <send>))
...
(cl:defmethod Rangular-val ((m <send>))
...
(cl:defmethod zAngle-val ((m <send>))
